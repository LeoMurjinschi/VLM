        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="p-8 md:p-12 prose prose-blue max-w-none text-gray-600">
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">3.1. Donors (Businesses)</h3>
              ...
              <h3 className="text-xl font-bold text-gray-800 mb-2">3.2. Receivers (NGOs)</h3>
              <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Account Verification</h2>
              <p className="mb-6 leading-relaxed">
