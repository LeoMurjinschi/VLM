                        ...
                        <div className="space-y-4">
                            {OPEN_POSITIONS.map((job) => (
                                ...
                                >
                                    ...
                                    <div>
                                        <AuthButton onClick={() => navigate(`/careers/apply/${job.id}`)} variant="outline" className="w-full md:w-auto group-hover:bg-blue-600 group-hover:text-white group-hover:border-blue-600">
