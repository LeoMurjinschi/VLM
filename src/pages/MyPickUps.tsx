...
import { MOCK_ACTIVE_PICKUPS, type Pickup } from '../_mock/myPickups';

const MyPickups: React.FC = () => {
  const { theme } = useTheme();
  
  // Avem doar lista activă acum
  const [activeList, setActiveList] = useState<Pickup[]>(MOCK_ACTIVE_PICKUPS);
  
  useEffect(() => {
    setActiveList(MOCK_ACTIVE_PICKUPS);
  }, [MOCK_ACTIVE_PICKUPS]);
